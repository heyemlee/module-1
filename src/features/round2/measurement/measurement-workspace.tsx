        ...
        <div className="sticky bottom-0 border-t border-studio-line bg-[rgba(248,248,246,0.94)] p-5 backdrop-blur-xl">
          {submitted && (
            <p className="mb-2 flex items-center gap-1.5 font-mono text-[9px] tracking-[0.1em] text-studio-quiet">
              ...
              MEASUREMENT v{state.measurementVersion} SUBMITTED · EDIT AND
              RESUBMIT TO REVISIT DESIGN INTENT
            </p>
          )}
          <Button
            type="button"
          ...
          >
            {submitted
              ? `Resubmit v${state.measurementVersion} → design intent`
              : `Submit v${state.measurementVersion} → design intent`}
          </Button>
        </div>
      </aside>
